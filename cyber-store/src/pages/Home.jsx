...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* HERO SECTION - REVERTED TO PREVIOUS HERO */}
      ...
      {/* FEATURED BANNER GRID - 4 EXACT PRODUCTS IN EXACT LOCATIONS */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
          <div className="space-y-4 max-w-lg z-10">
            ...
            <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-white">
              Sconti Estivi TechMania Fino al 15% OFF
            </h2>
            <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
              Usa il codice sconto <span className="font-bold text-white bg-gray-800 px-2 py-0.5 rounded">TECHMANIA10</span> al checkout per risparmiare subito su tutti i gadget e accessori.
            </p>
            <div>
              <Link to="/products">
                <motion.div
