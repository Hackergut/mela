    ...
    <div className="min-h-screen bg-white pt-6 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-2 pt-4 border-t border-gray-100 text-center">
              <div className="flex flex-col items-center gap-1 p-2">
                ...
                <span className="text-[11px] font-semibold text-gray-600">Free Shipping</span>
              </div>
              <div className="flex flex-col items-center gap-1 p-2">
                <ShieldCheck className="w-5 h-5 text-gray-700" />
                <span className="text-[11px] font-semibold text-gray-600">1 Year Warranty</span>
              </div>
              <div className="flex flex-col items-center gap-1 p-2">
        ...
        {relatedProducts.length > 0 && (
          <div>
            <h2 className="text-2xl font-black text-black tracking-tight mb-8">Related Products</h2>
