...
export const PRODUCT_CATALOG = [
  // ===== iPhone 17 Pro =====
  { id: 1, name: 'iPhone 17 Pro — Arancione Cosmico', price: '€1.199', badge: 'Nuovo', category: 'iPhone', image: `${IMG}/a53ee8668_IMG_1669.webp`,
    description: 'iPhone 17 Pro nella finitura Arancione Cosmico. Chip A19 Pro, display ProMotion da 6,3" e struttura in alluminio forgiato.' },
  { id: 2, name: 'iPhone 17 Pro — Modulo Fotocamera', price: '€1.199', badge: 'Nuovo', category: 'iPhone', image: `${IMG}/b9530564b_IMG_1670.jpeg`,
    description: 'Macro sul modulo fotocamera dell\'iPhone 17 Pro Arancione Cosmico. Tripla fotocamera con teleobiettivo 5x.' },
  { id: 3, name: 'iPhone 17 Pro — Dettaglio Obiettivi', price: '€1.199', badge: null, category: 'iPhone', image: `${IMG}/2abb70f56_IMG_1671.jpeg`,
    description: 'Primo piano sugli obiettivi dell\'iPhone 17 Pro. Lenti smerigliate e sensore da 48MP per scatti da professionista.' },
  { id: 4, name: 'iPhone 17 Pro — Fronte e Retro', price: '€1.199', badge: 'Nuovo', category: 'iPhone', image: `${IMG}/f731cdad5_IMG_1704.png`,
    description: 'iPhone 17 Pro Arancione Cosmico visto fronte e retro. Display Super Retina XDR e Ceramic Shield 2.' },
  { id: 5, name: 'iPhone 17 Pro — Comparto Fotografico', price: '€1.199', badge: null, category: 'iPhone', image: `${IMG}/b2fed9641_IMG_1705.png`,
    description: 'Il comparto fotografico dell\'iPhone 17 Pro in evidenza su fondo scuro. Fotografia computazionale di nuova generazione.' },
  { id: 6, name: 'iPhone 17 Pro — Arancione e Blu', price: '€1.199', badge: null, category: 'iPhone', image: `${IMG}/928b2127d_IMG_1668.webp`,
    description: 'Due iPhone 17 Pro a confronto, Arancione Cosmico e Blu. Scegli la finitura che ti rappresenta.' },
  { id: 7, name: 'iPhone 17 Pro — Tre Finiture', price: '€1.199', badge: 'Nuovo', category: 'iPhone', image: `${IMG}/bf58c6cc9_IMG_1706.png`,
    description: 'iPhone 17 Pro nelle tre finiture disponibili: Argento, Arancione Cosmico e Blu.' },
  { id: 8, name: 'iPhone 17 Pro — Argento', price: '€1.199', badge: null, category: 'iPhone', image: `${IMG}/5eced5370_IMG_1679.webp`,
    description: 'iPhone 17 Pro Argento visto di profilo. Spessore ridotto e cornici sottilissime per un feel premium.' },
  { id: 9, name: 'iPhone 17 Pro — Argento Fronte e Retro', price: '€1.199', badge: null, category: 'iPhone', image: `${IMG}/4552cdca7_IMG_1680.webp`,
    description: 'iPhone 17 Pro Argento in doppia vista, fronte e retro. Design pulito e materiali di grado professionale.' },
  { id: 10, name: 'iPhone 17 Pro — Nero e Rame', price: '€1.199', badge: null, category: 'iPhone', image: `${IMG}/e0d184381_IMG_1648.webp`,
    description: 'Due iPhone 17 Pro tenuti in mano nelle finiture Nero e Rame. Ergonomia perfetta e presa sicura.' },

  // ===== iPhone 17 =====
  { id: 11, name: 'iPhone 17 — Tutte le Finiture', price: '€899', badge: 'Nuovo', category: 'iPhone', image: `${IMG}/37d4e3218_IMG_1673.webp`,
    description: 'La gamma iPhone 17 al completo. Chip A19, doppia fotocamera da 48MP e display Super Retina XDR.' },
  { id: 12, name: 'iPhone 17 — Lineup Completa', price: '€899', badge: null, category: 'iPhone', image: `${IMG}/9567fcd33_IMG_1678.webp`,
    description: 'Tutti i colori dell\'iPhone 17 allineati in prospettiva. Un modello per ogni stile.' },
  { id: 13, name: 'iPhone 17 — Gamma Colori', price: '€899', badge: null, category: 'iPhone', image: `${IMG}/58f298cc3_IMG_1707.png`,
    description: 'iPhone 17 disposti a ventaglio in tutte le colorazioni. Design rinnovato e prestazioni eccezionali.' },

  // ===== iPhone 17 Air =====
  { id: 14, name: 'iPhone 17 Air — Azzurro', price: '€999', badge: 'Nuovo', category: 'iPhone', image: `${IMG}/ae167da00_IMG_1676.webp`,
    description: 'iPhone 17 Air in Azzurro, dettaglio fotocamera. Il più sottile mai realizzato, con soli 5,6 mm di spessore.' },
  { id: 15, name: 'iPhone 17 Air — Azzurro Dettaglio', price: '€999', badge: null, category: 'iPhone', image: `${IMG}/502c9901e_IMG_1684.jpeg`,
    description: 'Primo piano sul modulo fotocamera dell\'iPhone 17 Air Azzurro. Leggerezza estrema senza compromessi.' },
  { id: 16, name: 'iPhone 17 Air — Azzurro Retro', price: '€999', badge: null, category: 'iPhone', image: `${IMG}/e7b796fbe_IMG_1685.jpeg`,
    description: 'Il retro dell\'iPhone 17 Air Azzurro con logo Apple. Vetro opaco resistente alle impronte.' },
  { id: 17, name: 'iPhone 17 Air — Bianco', price: '€999', badge: null, category: 'iPhone', image: `${IMG}/dabbb9a2e_IMG_1682.webp`,
    description: 'iPhone 17 Air in Bianco. Purezza e minimalismo con la potenza del chip A19.' },
  { id: 18, name: 'iPhone 17 Air — Bianco Dettaglio', price: '€999', badge: null, category: 'iPhone', image: `${IMG}/63d33f72a_IMG_1683.webp`,
    description: 'Dettaglio angolato dell\'iPhone 17 Air Bianco. Profilo sottilissimo e finiture curatissime.' },

  // ===== iPhone 16 =====
  { id: 19, name: 'iPhone 16 — Verde', price: '€799', badge: null, category: 'iPhone', image: `${IMG}/bbc5ad376_IMG_1647.jpeg`,
    description: 'iPhone 16 in Verde, vista di profilo e retro. Controllo Fotocamera e chip A18 per prestazioni brillanti.' },
  { id: 20, name: 'iPhone 16 — Verde Fronte e Retro', price: '€799', badge: null, category: 'iPhone', image: `${IMG}/afaae44e7_IMG_1675.webp`,
    description: 'iPhone 16 Verde in doppia vista. Display Super Retina XDR da 6,1" e batteria che dura tutto il giorno.' },
  { id: 21, name: 'iPhone 16 — Viola', price: '€799', badge: null, category: 'iPhone', image: `${IMG}/41f49baf1_IMG_1674.webp`,
    description: 'iPhone 16 in Viola con prospettiva angolata. Colori vivaci e vetro colorato in massa.' },
  { id: 22, name: 'iPhone 16 — Viola Fotocamera', price: '€799', badge: null, category: 'iPhone', image: `${IMG}/20b84ec9d_IMG_1677.jpeg`,
    description: 'Dettaglio ravvicinato della fotocamera dell\'iPhone 16 Viola. Doppia lente verticale da 48MP.' },
  { id: 23, name: 'iPhone 16 — Rosa', price: '€799', badge: null, category: 'iPhone', image: `${IMG}/bb0ae7c20_IMG_1646.jpeg`,
    description: 'iPhone 16 in Rosa, macro sul modulo fotocamera. Design elegante e scatti sempre nitidi.' },
  { id: 24, name: 'iPhone 16 — Crema', price: '€799', badge: null, category: 'iPhone', image: `${IMG}/4fd4fd8a0_IMG_1681.webp`,
    description: 'iPhone 16 in Crema, doppia angolazione posteriore e laterale. Tonalità calda e raffinata.' },
