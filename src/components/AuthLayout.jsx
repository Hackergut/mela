  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] font-sans flex flex-col">
      ...
      <main className="relative flex-1 flex items-center justify-center overflow-hidden bg-black px-4 py-16">
        {/* Glow ambientale */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-[#FF6B35]/20 blur-[120px] pointer-events-none" />
        <div className="absolute top-0 left-1/4 w-[300px] h-[300px] rounded-full bg-[#FF6B35]/10 blur-[100px] pointer-events-none" />

        <div className="relative w-full max-w-md">
          {/* Header */}
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-[#FF6B35] mb-5 shadow-lg shadow-[#FF6B35]/30">
          ...
          {/* Footer */}
          {footer && (
            <p className="text-center text-sm text-white/60 mt-6 [&_a]:text-[#FF6B35] [&_a]:font-medium [&_a]:hover:underline">
              {footer}
            </p>
          )}
        </div>
